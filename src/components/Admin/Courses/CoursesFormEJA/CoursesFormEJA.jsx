        ...
        <div className="CoursesFormEJA">
           <h3>Cadastrar Cursos</h3>
                ...
                <label className="label-avatar">
                    ...
                    <textarea name="" id="" cols="30" rows="5" placeholder="Métodos de estudo" value={methodStudy} onChange={(e) => setMethodStudy(e.target.value)}></textarea>
                    <textarea name="" id="" cols="30" rows="5" placeholder="Avaliações" value={evaluation} onChange={(e) => setEvaluation(e.target.value)}></textarea>
                    <textarea name="" id="" cols="30" rows="5" placeholder="Documentação e validação" value={documentation} onChange={(e) => setDocumentation(e.target.value)}></textarea>
                    <textarea name="" id="" cols="30" rows="5" placeholder="Clasificação em série/etapa do Ensino Fundamental para acesso ao Ensino Médio" value={classification} onChange={(e) => setClassification(e.target.value)}></textarea>
